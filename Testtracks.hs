...
b1 :: Section
b1 = Section { state=Occupied, prev=["A1"], next=["C1"], speedlim=113, loco=testLoco2, sid="B1", prevturn=Noturn, nextturn=Noturn }

b2 :: Section
b2 = Section { state=Occupied, prev=["A2"], next=["C2","C1"], speedlim=113, loco=testLoco, sid="B2", prevturn=Noturn, nextturn=Unset }
