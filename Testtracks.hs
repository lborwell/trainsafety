...
testLoco :: Locomotive
testLoco = Locomotive { slot=8, speed=115, ide=2, direction=FWD, waiting=False, prevspeed=0 }

testLoco2 :: Locomotive
testLoco2 = Locomotive { slot=9, speed=116, ide=2, direction=FWD, waiting=True, prevspeed=50 }
...
b1 :: Section
b1 = Section { state=Empty, prev=["A1"], next=["C1"], speedlim=113, loco=testLoco, sid="B1", prevturn=Noturn, nextturn=Noturn }

b2 :: Section
b2 = Section { state=Empty, prev=["A2"], next=["C2","C1"], speedlim=113, loco=testLoco2, sid="B2", prevturn=Noturn, nextturn=Set }
